...
import { useCanvasJournal } from 'features/canvas';
import { CanvasJournalList, WhiteboardCanvas } from 'widgets/canvas';
import type { Stroke, TextElement, TransformState } from 'entities/canvas';
        ...
        return (
            ...
            "
                ...
                <WhiteboardCanvas
                    ...
                    initialData={{
                        strokes: activeCanvas.strokes as Stroke[],
                        texts: activeCanvas.texts as TextElement[],
