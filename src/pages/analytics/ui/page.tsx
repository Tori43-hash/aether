...
import type { Stat, Timeframe, ChartStyle, ChartColor } from '../../../entities/trades';
import { formatPercent } from '../../../shared/lib';
import { DebouncedColorInput, PageGrid, PageSection, PageHeader } from '../../../shared/ui';
import { ProgressiveChart } from '../../../widgets/charts';
import { calculateRiskStats, useTrades } from '../../../entities/trades';
...
const StatsComponent: React.FC<StatsProps> = ({ changeTab }) => {
    ...
    return (
        <PageGrid>
            ...
            <PageSection columns="1-2" gap="lg">
                {/* Sidebar - Metrics List */}
                <div className="space-y-4 blur-loading animate-blur-in">
                ...
                {/* Chart */}
                <div className="soft-card chart-card flex flex-col blur-loading animate-blur-in">
            ...
            <PageSection columns={3} gap="md">
                <div className="soft-card stat-card group hover:border-rose-200 transition blur-loading animate-blur-in" style={{ animationDelay: '0.1s' }}>
                ...
                <div className="soft-card stat-card group hover:border-green-200 transition blur-loading animate-blur-in" style={{ animationDelay: '0.15s' }}>
                    <div className="flex justify-between items-start">
                ...
                <div className="soft-card stat-card group hover:border-orange-200 transition blur-loading animate-blur-in" style={{ animationDelay: '0.2s' }}>
                    <div className="flex justify-between items-start">
...
StatsComponent.displayName = 'Analytics';

export const Analytics = React.memo(StatsComponent);
