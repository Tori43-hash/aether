...
const DashboardPageComponent: React.FC<DashboardPageProps> = ({ openTradeModal, changeTab }) => {
    ...
    return (
        <PageGrid>
            ...
            <PageHeader
                title={
                    <>
                        ...
                        <span title="Funded Trader"><BadgeCheck className="w-6 h-6 verified-badge inline ml-3" /></span>
                    </>
                }
                subtitle="Here is your Weekly briefing."
                actions={
                    <div className="text-right flex flex-col items-end">
                        <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Total Return</span>
                        <div className={`text-3xl font-light tracking-tight mb-2 ${totalPnL >= 0 ? 'text-green-600' : 'text-rose-500'}`}>
            ...
            {/* Chart Section */}
            <PageSection columns={1}>
                <div className="soft-card chart-card blur-loading animate-blur-in">
            ...
            <PageSection columns={3} gap="md">
                <div className="soft-card stat-card group hover:border-blue-200 transition blur-loading animate-blur-in" style={{ animationDelay: '0.1s' }}>
                ...
                <div className="soft-card stat-card group hover:border-blue-200 transition blur-loading animate-blur-in" style={{ animationDelay: '0.15s' }}>
                    <div className="flex justify-between items-start">
                ...
                <div className="soft-card stat-card group hover:border-blue-200 transition blur-loading animate-blur-in" style={{ animationDelay: '0.2s' }}>
                    <div className="flex justify-between items-start">
