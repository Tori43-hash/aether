...
import { Shortcuts, BackgroundType, DisplayPosition, DisplaySize } from '../../lib/types';
import { DEFAULT_SHORTCUTS, LS_KEYS, DEFAULT_ZOOM_SPEED } from '../../lib/constants';
...
export const useWhiteboardSettings = (): UseWhiteboardSettingsReturn => {
    // Shortcuts
