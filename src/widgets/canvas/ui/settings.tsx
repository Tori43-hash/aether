...
import { Shortcuts, ShortcutConfig, BackgroundType, DisplayPosition, DisplaySize, DEFAULT_SHORTCUTS } from 'entities/canvas';
import { getEnglishKeyFromCode } from 'widgets/canvas/lib/utils/geometry';
