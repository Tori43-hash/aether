...
import { WhiteboardTextToolbarContainer } from './toolbarContainer';
...
import { useHistory } from '../model/hooks/useHistory';
import { useTransform } from '../model/hooks/useTransform';
import { useSelection } from '../model/hooks/useSelection';
import { useEvents } from '../model/hooks/useEvents';
import { useShortcuts } from '../model/hooks/useShortcuts';
import { useCanvas } from '../model/hooks/useCanvas';

// Sub-components
import { WhiteboardToolbar } from './toolbar';
import { WhiteboardSettingsModal } from './settings';
import { DisplayInfo } from './info';
import { WhiteboardTextEditor } from './textEditor';
...
export const WhiteboardCanvas: React.FC<WhiteboardCanvasProps> = ({
  ...
  const { currentZoom, setCurrentZoom, resetView } = useTransform({
    canvasRef,
    transformRef,
    zoomSpeed,
    scheduleRedrawRef,
  ...
  const { scheduleRedraw, isScheduledRef, requestRef } = useCanvas({
    canvasRef,
    containerRef,
    transformRef,
    strokesRef,
